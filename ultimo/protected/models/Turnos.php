...
class Turnos extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array(' horaEntrada, horaSalida, nombreTurno', 'required','message'=>'{attribute}:debe completar campo'),
			array('idTurnos', 'numerical', 'integerOnly'=>true),
			array('nombreTurno', 'length', 'max'=>45),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('idTurnos, horaEntrada, horaSalida, nombreTurno', 'safe', 'on'=>'search'),
		);
	}
	...
	public function relations()
	{
		...
		return array(
			'horarios' => array(self::HAS_MANY, 'Horario', 'Turnos_idTurnos'),
		);
	}
	...
	public function search()
	{
		...
		$criteria->compare('idTurnos',$this->idTurnos);
