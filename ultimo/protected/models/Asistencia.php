 ...
 * @property string $registroEntrada
 * @property string $registroSalida
...
class Asistencia extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('idAsistencia, Empleado_idEmpleado', 'required'),
			array('idAsistencia, Empleado_idEmpleado', 'numerical', 'integerOnly'=>true),
			array('registroEntrada, registroSalida', 'safe'),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('idAsistencia, registroEntrada, registroSalida, Empleado_idEmpleado', 'safe', 'on'=>'search'),
		);
	}
	...
	public function attributeLabels()
	{
		return array(
			...
			'registroEntrada' => 'Registro Entrada',
	...
	public function search()
	{
		...
		$criteria->compare('registroEntrada',$this->registroEntrada,true);
		$criteria->compare('registroSalida',$this->registroSalida,true);
