 ...
 * @property string $inicioVaca
 * @property string $terminoVaca
...
class Vacaciones extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('inicioVaca, terminoVaca, Empleado_idEmpleado', 'required'),
			array('Empleado_idEmpleado', 'numerical', 'integerOnly'=>true),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('idVacaciones, inicioVaca, terminoVaca, Empleado_idEmpleado', 'safe', 'on'=>'search'),
		);
	}
	...
	public function attributeLabels()
	{
		return array(
			...
			'inicioVaca' => 'Inicio Vaca',
			'terminoVaca' => 'Termino Vaca',
	...
	public function search()
	{
		...
		$criteria->compare('inicioVaca',$this->inicioVaca,true);
		$criteria->compare('terminoVaca',$this->terminoVaca,true);
